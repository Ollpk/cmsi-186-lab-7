public class MazeTest extends TestSuite {
    ...
    public Test[] getTests() {
        return new Test[] {
                new Test("A non square maze",
                        () -> expectThrows(() -> Maze.fromString("ooo\noo"), IllegalArgumentException.class,
                                "Non-rectangular maze")),
                new Test("Multiple rats",
                        () -> expectThrows(() -> Maze.fromString("woor\noorc"), IllegalArgumentException.class,
                                "Maze can only have one rat")),
                new Test("Multiple cheeses",
                        () -> expectThrows(() -> Maze.fromString("wooo\noccr"), IllegalArgumentException.class,
                                "Maze can only have one cheese")),
                new Test("No rats",
                        () -> expectThrows(() -> Maze.fromString("wooo\nowcw"), IllegalArgumentException.class,
                                "Maze has no rat")),
                new Test("No cheese", () -> expectThrows(() -> Maze.fromString("row\noww"),
